export const messages = {
  ...
  vpn: {
    ...
    text: "Your network connection seems to have drifted away. Could you help me find it ?<br/><br/>Please check your internet connectivity or your VPN connection."
  },
  aws: {
