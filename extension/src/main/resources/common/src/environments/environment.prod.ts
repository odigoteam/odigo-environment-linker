export const environment = {
  production: true,
  configurationUrlPattern : "https:\/\/.+\/raw\/master\/configuration\.json",
  ...
  releaseNote: {
    title: "Ha Ha Ha Ha Staying alive ! <i class=\"bi bi-music-note-beamed\"></i> Nightclubs are reopened in France ! And to celebrate the good time (Come on !), here's some rhythm news just for you. <i class=\"bi bi-boombox-fill\"></i>",
    features: [
      {
