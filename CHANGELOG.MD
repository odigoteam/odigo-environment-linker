...
## [Unreleased]
### Added
- Upgrade Angular to latest (14.0.3)
- Cluster ID badge per environment
- Manage a list of AWS roles
- Uncheck all versions if uncheck All option in versions filter
### Fixed
- Issue #5 Apero page is not disappearing after closing
## [4.5.3]
### Added
- New commands (apéro and weekend) which tell you if it's time for apero or for the weekend (french only).
### Fixed
...
- Focus on search input at launch.
## [4.5.1] / [4.5.2]
### Fixed
...
[Unreleased]: https://github.com/guitaro/odigo-environment-linker/compare/v4.5.3...HEAD
